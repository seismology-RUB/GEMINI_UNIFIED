...
!------------------------------------------------------------------------
  ...
  if (abs(z+1.d0) > epsilon(1.d0)) then  ! if (z /= -1.d0)
    pnglj = (pnleg(z,n)+pnleg(z,n+1))/(1.d0+z)
  else
    pnglj = (dble(n)+1.d0)*(-1)**n
  endif
...
!------------------------------------------------------------------------
  ...
  if (abs(z+1.d0) > epsilon(1.d0)) then  ! if (z /= -1.d0)
    pndglj = (pndleg(z,n)+pndleg(z,n+1))/(1.d0+z) - (pnleg(z,n)+pnleg(z,n+1))/((1.d0+z)**2)
  else
