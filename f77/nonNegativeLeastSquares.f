C------------------------------------------------------------------------
C  downloaded from http://www.netlib.org/lawson-hanson/all
C
...
C   
      ASAVE=A(NPP1,J)   
c      CALL H12 (1,NPP1,NPP1+1,M,A(1,J),1,UP,DUMMY,1,1,0)  ! WF
      call h12 (1,NPP1,NPP1+1,M,A(1,J),1,UP,ZZ,1,1,0)
      UNORM=ZERO
      IF (NSETP .ne. 0) then
          DO 90 L=1,NSETP   
