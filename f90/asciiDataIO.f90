...
!
	subroutine readComplexVectorAsciiDataIO(filename,lu,p,errmsg,ndata,nskip)
	! incoming
...
!
	...
	end subroutine readComplexVectorAsciiDataIO
!------------------------------------------------------------------------
...
!! \return error message
!
	subroutine readRealMatrixAsciiDataIO(filename,lu,p,errmsg,ncol,nrow,nskip)
	! incoming
	character(len=*) :: filename
	integer :: lu
	type (error_message) :: errmsg
...
!
	...
	end subroutine readRealMatrixAsciiDataIO
!------------------------------------------------------------------------
...
!! \return error message
!
	subroutine readComplexMatrixAsciiDataIO(filename,lu,p,errmsg,ncol,nrow,nskip)
	! incoming
	character(len=*) :: filename
	integer :: lu
	type (error_message) :: errmsg
...
!
	...
	end subroutine readComplexMatrixAsciiDataIO
!------------------------------------------------------------------------
...
!
	subroutine writeComplexVectorAsciiDataIO(filename,lu,val,errmsg)
	! incoming
	character(len=*) :: filename
	integer :: lu
...
!
	close(lu)
	end subroutine writeComplexVectorAsciiDataIO
!------------------------------------------------------------------------
...
!       * add sophisticated overwrite handling
!
	subroutine writeComplexMatrixAsciiDataIO(filename,lu,val,errmsg)
	! incoming
	character(len=*) :: filename
	integer :: lu
	complex, dimension(:,:) :: val
...
!
	close(lu)
	end subroutine writeComplexMatrixAsciiDataIO
!------------------------------------------------------------------------
...
!       * add sophisticated overwrite handling
!
	subroutine writeRealVectorAsciiDataIO(filename,lu,val,errmsg)
	! incoming
	character(len=*) :: filename
	integer :: lu
	real, dimension(:) :: val
...
!
	close(lu)
	end subroutine writeRealVectorAsciiDataIO
!------------------------------------------------------------------------
...
!       * add sophisticated overwrite handling
!
	subroutine writeRealMatrixAsciiDataIO(filename,lu,val,errmsg)
	! incoming
	character(len=*) :: filename
	integer :: lu
	real, dimension(:,:) :: val
...
!
	close(lu)
	end subroutine writeRealMatrixAsciiDataIO
!
