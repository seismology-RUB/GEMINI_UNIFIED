...
!
 module dateTime
    ...
    integer, parameter :: date_time_string_length = 25
    type date_time
        private
...
!
    subroutine printDateTime(this,lu)
    type (date_time) :: this
    integer, optional :: lu
    integer :: llu
    if (present(lu)) then; llu=lu; else; llu = 6; endif
    write(llu,'(i4.4,i3.3,a1,3i2.2,a1,i9.9)') this%year,this%doy,'_',this%hh,this%mm,this%ss,'_',this%ns
